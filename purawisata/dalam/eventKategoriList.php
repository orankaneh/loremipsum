...
$minLevel = 800;
$hakAksesAplikasi = 0;
$judulnya = "Daftar Kategori event";
...
$i = 0;
$sql = "select * from ".tabel_event." where 1 and kategori='1' ".$addSql." order by id desc ";
...
while($row=mysql_fetch_object($res)) {
	...
	$ui .=
		'<tr>
			...
			<td align="left" valign="top"><a href="eventKategoriUpdate.php?id='.$row->id.'">'.$row->nama.'</a></td>
...
<div class="judul_menu">Daftar Kategori event</div>
