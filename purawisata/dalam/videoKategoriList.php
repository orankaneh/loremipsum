...
$minLevel = 800;
$hakAksesAplikasi = 0;
$judulnya = "Daftar Kategori Video";
...
$i = 0;
$sql = "select * from ".tabel_video." where 1 and kategori='1' ".$addSql." order by id desc ";
...
while($row=mysql_fetch_object($res)) {
	...
	$induk = "";
	if($row->parent_id>0) {
		$sqlK = "select nama from ".tabel_video." where kategori='1' and id='".$row->parent_id."' ";
	...
	$ui .=
		'<tr>
			...
			<td align="left" valign="top"><a href="videoKategoriUpdate.php?id='.$row->id.'">'.$row->nama.'</a></td>
...
<div class="judul_menu">Daftar Kategori Video</div>
