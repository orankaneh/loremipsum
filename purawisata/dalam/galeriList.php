...
$i = 0;
$sql = "select * from ".tabel_foto." where 1 and kategori='0' ".$addSql." order by id desc ";
...
while($row=mysql_fetch_object($res)) {
	...
	$ui .=
		'<tr>
			...
			<td align="left" valign="top"><a href="galeriUpdate.php?id='.$row->id.'">'.$row->nama.'</a></td>
			<td align="center" valign="top"><img src="../images/foto/thumb/'.$row->id.'.jpg"></td>
...
<div class="judul_menu">Daftar Foto</div>
...
<form name="cari" action="" method="get">
	...
	<?=katUI("galeri","parent_id",$parent_id,"inputpesan tbless")?>
