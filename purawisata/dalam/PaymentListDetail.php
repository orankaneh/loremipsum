...
<div class="judul_menu">List Detail Pembayaran</div>
...
<table border="1">
<tr>
<th bordercolor="#000000" bgcolor="161616"><span class="style1" style="color: #ffffff;">Paket</span></th>
<th bordercolor="#000000" bgcolor="161616"><span class="style1" style="color: #ffffff;">Jumlah</span></th>
<th bordercolor="#000000" bgcolor="161616"><span class="style1" style="color: #ffffff;">Harga Rp</span></th>
<th bordercolor="#000000" bgcolor="161616"><span class="style1" style="color: #ffffff;">Harga $</span></th>
<th bordercolor="#000000" bgcolor="161616"><span class="style1" style="color: #ffffff;">Total Rp</span></th>
<th bordercolor="#000000" bgcolor="161616"><span class="style1" style="color: #ffffff;">Total $</span></th>
</tr>';
...
Email ini adalah sebagai bukti lunas untuk :'.$table.' 

-----------------------------------------------------------------------------------------------------  
<br/><br/>
Dear '.$lname.',  

This is a payment receipt for : '.$table.' 
<br/>
...
Regards | Salam,  <br/>
PT. Ganesha Dwipaya Bhakti  <br/>
Purawisata Yogyakarta <br/>
-----------------------------------------------<br/>
...
Email : info@purawisatajogjakarta.com
';
			
			

	kirimEmail("../", "true", $email, "info@purawisatajogjakarta.com", "billing@purawisatajogjakarta.com", "Billing at Purawisata Jogjakarta", "Payment Information at Purawisata Jogjakarta", $truehtml);	
header("location:PaymentList.php");
}
?>
<a href="PaymentList.php">Kembali ke daftar pembayaran</a>
<br/><br/><br/>

<a class="tombol" href="?action=confirm&id=<?=$id?>&booking=<?=$invoice_number?>">Proses Transaksi</a>
<?php
