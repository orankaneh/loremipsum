...
$minLevel = 800;
$hakAksesAplikasi = 0;
$judulnya = "Daftar Kategori Berita";
...
$i = 0;
$sql = "select * from ".tabel_berita." where 1 and kategori='1' ".$addSql." order by id desc ";
...
while($row=mysql_fetch_object($res)) {
	...
	$ui .=
		'<tr>
			...
			<td align="left" valign="top"><a href="beritaKategoriUpdate.php?id='.$row->id.'">'.$row->nama.'</a></td>
...
<div class="judul_menu">Daftar Kategori Berita</div>
