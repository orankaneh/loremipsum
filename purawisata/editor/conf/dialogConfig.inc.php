...
$WPRO_IMAGE_URL = '/ef/images/gambar/';             	 // web URL of your images folder
$WPRO_IMAGE_DIR = '/ef/images/gambar/';                 // file path of the folder above
$WPRO_DOC_URL = '/ef/images/dokumen/';              	 // web URL of your downloadable documents folder
$WPRO_DOC_DIR = '/ef/images/dokumen/';                   // file path of the folder above
